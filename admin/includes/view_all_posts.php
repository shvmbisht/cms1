    ...
    $post_date = $row['post_date'];
     ...
     $post_views_count= $row['post_views_count'];
       ...
       $query = " INSERT INTO posts(
                                   post_title,post_category_id,post_author,post_status,post_image,post_tags,post_content,
                                   post_date) "; 
...
<form action="" method="post">
  ...
  <div class="col-xs-4"><input type="submit" name="submit" class="btn btn-success" value="Apply">
